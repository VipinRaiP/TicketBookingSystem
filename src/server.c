...
void  connectionHandler(struct clientInfo *arg){
	...
	while(1){
		...
		{      
			...
			/*		if(updateNoUsers(uid,userLockFd,creq.acc.uid)){
						printf("Updated no of users\n");
					}
					else{
						printf("cannot update no of users\n");
					}	*/
                                        break;
				case MODIFY_ACCOUNT :
		...
		/*			if(decNoUsers(uid,userLockFd,creq.acc.uid)){
						printf("Decreased no of users\n");
					}
					else{
						printf("cannot decrease no of users\n");
					}	*/
					break;
				case SEARCH_ACCOUNT :
			...
			/*		if(updateNoTrains(uid,userLockFd,creq.tr.trainNo)){
						printf("Updated no of trains\n");
					}
					else{
						printf("cannot update no of  trains\n");
					}	*/
                                        break;
		...
		/*			if(decNoTrains(uid,userLockFd,creq.tr.trainNo)){
						printf("Decreased no of trains\n");
					}
					else{
						printf("cannot decrease no of trains\n");
					}	*/
					break;
				case SEARCH_TRAIN :
